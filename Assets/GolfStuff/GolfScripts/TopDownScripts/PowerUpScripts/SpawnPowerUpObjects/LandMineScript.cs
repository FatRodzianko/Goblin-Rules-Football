...
public class LandMineScript : NetworkBehaviour
{
    ...
    public bool WillLandMineBlowUp(GolfBallTopDown golfBallAsking)
    {
        Debug.Log("WillLandMine: Golfball with player connection id of: " + golfBallAsking.MyPlayer.ConnectionId.ToString());
    ...
    public void BlowUpLandMine(GolfBallTopDown golfBallThatInitiatedThis)
    {
